...
<string>MyApp would like to remain connected to nearby bluetooth GameWindow Controllers and GameWindow Pads even when you're not using the app.</string>


GameWindow Center 
==============================================================================

GameWindow Center integration might require that you break up your main loop in order to yield control back to the system. In other words, instead of running an endless main loop, you run each frame in a callback function, using:
...
e.g.
    ...
    #if __IPHONEOS__
        // Initialize the GameWindow Center for scoring and matchmaking
        InitGameCenter();
    
        // Set up the game to run in the window animation callback on iOS
        // so that GameWindow Center and so forth works correctly.
